...
async function saveUserState(userId, updates) {
    ...
    const nextState = {
        ...
        trackingStartedAt: normalizeIsoTimestamp(updates?.trackingStartedAt ?? currentState.trackingStartedAt),
        activeSince: normalizeIsoTimestamp(updates?.activeSince ?? currentState.activeSince),
        idleSince: normalizeIsoTimestamp(updates?.idleSince ?? currentState.idleSince),
        lastHeartbeatAt: normalizeIsoTimestamp(updates?.lastHeartbeatAt ?? currentState.lastHeartbeatAt),
        lastActivityAt: normalizeIsoTimestamp(updates?.lastActivityAt ?? currentState.lastActivityAt),
